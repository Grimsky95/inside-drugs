...
RegisterNetEvent(cfg.TriggerPrefix..':playerLoaded', function(xPlayer)
    PlayerData = xPlayer
end)

RegisterNetEvent(cfg.TriggerPrefix..':setJob', function(job)
    local Check = 0
...
CreateThread(function()
    PlayerData = cfg.Prefix.GetPlayerData()
