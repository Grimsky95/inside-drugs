...
function handleUserChoice(choice) {
    $('#modal').fadeOut();
    $.post('https://inside-selldrugs/modalChoice', JSON.stringify(choice));
}
...
function showDeleteConfirmationModal() {
    ...
    $('#modal-button-accept').off('click').on('click', function() {
        if (currentDisplayedConversationId !== undefined) {
            $.post('https://inside-selldrugs/playerDeletedConversation', JSON.stringify(currentDisplayedConversationId));
